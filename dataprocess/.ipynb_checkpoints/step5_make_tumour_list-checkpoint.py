...
img_path = '../processed_data/process_step2/image'
seg_path = '../processed_data/process_step2/mask'

img_des_path = './processed_data/process_step2/image'
seg_des_path = './processed_data/process_step2/mask'
...
with open('../processed_data/process_step2/train_tumour.list', 'w') as f:
    for item in train_list:
        f.write(item[0]+' '+item[1]+'\n')
    f.close()
    
with open('../processed_data/process_step2/val_tumour.list', 'w') as f:
